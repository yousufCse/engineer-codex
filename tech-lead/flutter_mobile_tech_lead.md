...
// Top-level function হতে হবে — Isolate এ closure কাজ করে না
...
- Google নিজে recommend করে: **Riverpod**
  ...
  test:
    ...
    steps:
      ...
      - name: Setup Flutter
        ...
        with:
          flutter-version: '3.24.0'  # specific version pin করো
          channel: 'stable'
...
```dart
// dio_certificate_pinning package ব্যবহার করো
...
Navigation:
━━━━━━━━━
✅ go_router: ^14.x — Official Google router
...
✅ firebase_performance: ^0.10.x — Performance
```
